...
def problem2_4():
    ...
    num_random=[]
    for i in range(0,10):
        num_random.append(random.random()*5+30)
    print(num_random)
#%%    
"""
...
def problem2_7():
    ...
    side_one=float(input("Enter length of side one: "))
    side_two=float(input("Enter length of side two: "))
    side_three=float(input("Enter length of side three: "))
    s = 0.5*(side_one+side_two+side_three)
    x = s*(s-side_one)*(s-side_two)*(s-side_three)
    print ("Area of a triangle with sides",side_one,side_two,side_three,"is",x**.5)
...
def problem2_8(temp_list):
    total_num=0
    low_num=temp_list[0]
    high_num=temp_list[0]
    for i in range(0,len(temp_list)):
        total_num=total_num+temp_list[i]
        if temp_list[i]<low_num :
            low_num=temp_list[i]
        if temp_list[i]>high_num :
            high_num=temp_list[i]            
    ave_num=total_num/(len(temp_list))
    print("Average:",ave_num)
    print("High:",high_num)
    print("Low:",low_num)
